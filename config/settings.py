...
SECRET_KEY = 'django-insecure-4hbfipa6xcnzjzcc0-83z-am@lh!-j%j5s@a#v(i+=b3*6r6n='
...
SWAGGER_SETTINGS = {
    ...
    'USE_SESSION_AUTH': False, # Optional: disables the login/logout button for session auth
}
